...
import net.typeblog.socks.soket_server.ProxySocketHandler
import net.typeblog.socks.soket_server.SocketRequestManager
...
class ProxySocketService : Service() {
    ...
    private fun startSocketServer() {
        ...
        try {
            serverSocket = ServerSocket(serverPort, 0, java.net.InetAddress.getByName("127.0.0.1"))
